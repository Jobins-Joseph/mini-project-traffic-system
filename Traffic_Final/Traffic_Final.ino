...
void count(){
  if(Tcount1>=Tcount2 && Tcount1>=Tcount3 && Tcount1>=Tcount4 && Tcount1>0)                        //T1
  {
...
delay(20000);
if(Tcount2>=Tcount3 && Tcount2>=Tcount4 && Tcount2>0)                                          //T1 T2
    {
digitalWrite(latchPin, LOW);
...
digitalWrite(latchPin, HIGH);
delay(20000);
 if(Tcount3>=Tcount4 && Tcount3>0)                                                            //T1 T2 T3 T4
      {
digitalWrite(latchPin, LOW);
...
if(Tcount1>=Tcount2 && Tcount1>=Tcount3 && Tcount1>0)
{
  digitalWrite(latchPin, LOW);
...
else if(Tcount2>=Tcount3 && Tcount2>0)
{
  digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00000101); 
shiftOut(dataPin, clockPin, MSBFIRST, B00101000);
digitalWrite(latchPin, HIGH);
delay(10000);
}
else if(Tcount3>0)
...
delay(10000);
      ...
      else if(Tcount4>=Tcount3 && Tcount4>0)                                                                 //T1 T2 T4 T3
      {
...
if(Tcount1>=Tcount2 && Tcount1>=Tcount4 && Tcount1>0)
{
  digitalWrite(latchPin, LOW);
...
else if(Tcount2>=Tcount4 && Tcount2>0)
{
  digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001001); 
...
delay(10000);
    ...
    else if(Tcount3>=Tcount4 && Tcount3>0)                                                                    //T1 T3
    {
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001010);
...
digitalWrite(latchPin, HIGH);
delay(20000);
if(Tcount2>=Tcount4 && Tcount2>0)                                                                       //T1 T3 T2 T4
      {
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001001);
shiftOut(dataPin, clockPin, MSBFIRST, B00100100);
...
delay(10000);
      ...
      else if(Tcount4>=Tcount2 && Tcount4>0)                                                  //T1 T3 T4 T2
      {
...
if(Tcount1>=Tcount3 && Tcount1>=Tcount4 && Tcount1>0)
{
  digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001100);
...
else if(Tcount3>=Tcount4 && Tcount3>0)
{
  digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001001);
shiftOut(dataPin, clockPin, MSBFIRST, B01000010);
...
digitalWrite(latchPin, HIGH);
delay(20000);
 if(Tcount2>=Tcount3 && Tcount2>0)                                            //T1 T4 T2 T3
      {
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00000101);
shiftOut(dataPin, clockPin, MSBFIRST, B00101000);
...
delay(10000);
      ...
      else if(Tcount3>=Tcount2 && Tcount3>0)                                                      // T1 T4 T3 T2
      {
...
delay(10000);
  ...
  else if(Tcount2>=Tcount3 && Tcount2>=Tcount4 && Tcount2>0)                                      //T2
  {
...
digitalWrite(latchPin, HIGH);
delay(20000);
if(Tcount1>=Tcount3 && Tcount1>=Tcount4 && Tcount1>0)                                          //T2 T1
    {
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001100);
shiftOut(dataPin, clockPin, MSBFIRST, B00010010); 
...
digitalWrite(latchPin, HIGH);
delay(20000);
 if(Tcount3>=Tcount4 && Tcount3>0)                                                            //T2 T1 T3 T4
      {
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001010);
shiftOut(dataPin, clockPin, MSBFIRST, B01000001); 
...
delay(10000);
      ...
      else if(Tcount4>=Tcount3 && Tcount4>0)                                            //T2 T1 T4 T3
      {
...
delay(10000);
    ...
    else if(Tcount3>=Tcount4 && Tcount3>0)                                                         //T2 T3
    {
...
digitalWrite(latchPin, HIGH);
delay(20000);
if(Tcount1>=Tcount4 && Tcount1>0)                                                            //T2 T3 T1 T4
      {
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001010);
shiftOut(dataPin, clockPin, MSBFIRST, B00010100); 
...
if(Tcount1>=Tcount3 && Tcount1>=Tcount2 && Tcount1>0)
{
  digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00000110); 
shiftOut(dataPin, clockPin, MSBFIRST, B00011000);
...
delay(10000);
      ...
      else if(Tcount4>=Tcount1 && Tcount4>0)                                                           //T2 T3 T4 T1
      {
...
if(Tcount2>=Tcount3 && Tcount2>=Tcount4 && Tcount2>0)
{
  digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001100); 
shiftOut(dataPin, clockPin, MSBFIRST, B00100001);
...
digitalWrite(latchPin, HIGH);
delay(20000);
 if(Tcount1>=Tcount3 && Tcount1>0)                                               //T2 T4 T1 T3
      {
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00000110);
shiftOut(dataPin, clockPin, MSBFIRST, B00011000); 
...
delay(10000);
      ...
      else if(Tcount3>=Tcount1 && Tcount3>0)                                          //T2 T4 T3 T1
      {
...
else if(Tcount3>=Tcount4 && Tcount3>0)                                         //T3
{
...
digitalWrite(latchPin, HIGH);
delay(20000);
if(Tcount1>=Tcount2 && Tcount1>=Tcount4 && Tcount1>0)                        //T3 T1
  {
...
digitalWrite(latchPin, HIGH);
delay(20000);
if(Tcount2>=Tcount4 && Tcount2>0)                                          //T3 T1 T2 T4
    { 
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001100);
shiftOut(dataPin, clockPin, MSBFIRST, B00100001); 
...
delay(10000);
    ...
    else if(Tcount4>=Tcount2 && Tcount4>0)                                                    //T3 T1 T4 T2
    {
...
delay(10000);
  ...
  else if(Tcount2>=Tcount4 && Tcount2>0)                                         //T3 T2
  {
...
digitalWrite(latchPin, HIGH);
delay(20000);
if(Tcount1>=Tcount4 && Tcount1>0)                                           //T3 T2 T1 T4
    {
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001100);
shiftOut(dataPin, clockPin, MSBFIRST, B00010010); 
...
delay(10000);
    ...
    else if(Tcount4>=Tcount1 && Tcount4>0)                                      //T3 T2 T4 T1
    {
...
digitalWrite(latchPin, HIGH);
delay(20000);
if(Tcount1>=Tcount2 && Tcount1>0)                                    //T3 T4 T1 T2
{
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00000110);
shiftOut(dataPin, clockPin, MSBFIRST, B00011000); 
...
else if(Tcount2>=Tcount1 && Tcount2>0)                                  //T3 T4 T2 T1
{
...
digitalWrite(latchPin, HIGH);
delay(20000);
if(Tcount1>=Tcount2 && Tcount1>=Tcount3 && Tcount1>0)        //T4 T1
  {
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00000110);
shiftOut(dataPin, clockPin, MSBFIRST, B00011000); 
...
digitalWrite(latchPin, HIGH);
delay(20000);
if(Tcount2>=Tcount3 && Tcount2>0)                          //T4 T1 T2 T3
    {
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001100);
shiftOut(dataPin, clockPin, MSBFIRST, B00100001); 
...
delay(10000);
    ...
    else if(Tcount3>=Tcount2 && Tcount3>0)                     //T4 T1 T3 T2
    {
...
delay(10000);
  ...
  else if(Tcount2>=Tcount3 && Tcount2>0)                    //T4 T2
  {
...
digitalWrite(latchPin, HIGH);
delay(20000);
if (Tcount1>=Tcount3 && Tcount1>0)                      //T4 T2 T1 T3
    {
digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001100);
shiftOut(dataPin, clockPin, MSBFIRST, B00010010); 
...
delay(10000);
    ...
    else if (Tcount3>=Tcount1 && Tcount3>0)        //T4 T2 T3 T1
    {
...
digitalWrite(latchPin, HIGH);
delay(20000);
if(Tcount1>=Tcount2 && Tcount1>0)                               //T4 T3 T1 T2
    {
...
delay(10000);
    ...
    else if(Tcount2>=Tcount1 && Tcount2>0)                              //T4 T3 T2 T1
    {
