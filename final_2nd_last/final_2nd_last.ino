...
void count(){
  ...
  {
    if(Tcount2>=Tcount3 && Tcount2>=Tcount4)                                          //T1 T2
    {
      if(Tcount3>=Tcount4)                                                            //T1 T2 T3 T4
      {
...
delay(10000);
      ...
      else if(Tcount4>=Tcount3)                                                                 //T1 T2 T4 T3
      {
        digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001110); 
shiftOut(dataPin, clockPin, MSBFIRST, B00000001);
...
delay(10000);
    ...
    else if(Tcount3>=Tcount4)                                                                    //T1 T3
    {
      if(Tcount2>=Tcount4)                                                                       //T1 T3 T2 T4
      {
       digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001110);
shiftOut(dataPin, clockPin, MSBFIRST, B00000001);
...
delay(10000);
      ...
      else if(Tcount4>=Tcount2)                                                  //T1 T3 T4 T2
      {
      digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001110);
shiftOut(dataPin, clockPin, MSBFIRST, B00000001);
...
delay(10000);
    ...
    {
      if(Tcount2>=Tcount3)                                            //T1 T4 T2 T3
      {
...
delay(10000);
      ...
      else if(Tcount3>=Tcount2)                                                      // T1 T4 T3 T2
      {
      digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001110);
shiftOut(dataPin, clockPin, MSBFIRST, B00000001);
...
delay(10000);
  ...
  else if(Tcount2>=Tcount3 && Tcount2>=Tcount4)                                      //T2
  {
    if(Tcount1>=Tcount3 && Tcount1>=Tcount4)                                          //T2 T1
    {
      if(Tcount3>=Tcount4)                                                            //T2 T1 T3 T4
      {
...
delay(10000);
      ...
      else if(Tcount4>=Tcount3)                                            //T2 T1 T4 T3
      {
...
delay(10000);
    ...
    else if(Tcount3>=Tcount4)                                                         //T2 T3
    {
      if(Tcount1>=Tcount4)                                                            //T2 T3 T1 T4
      {
         digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001101); 
shiftOut(dataPin, clockPin, MSBFIRST, B00000010);
...
delay(10000);
      ...
      else if(Tcount4>=Tcount1)                                                           //T2 T3 T4 T1
      {
...
delay(10000);
    ...
    {
      if(Tcount1>=Tcount3)                                               //T2 T4 T1 T3
      {
...
delay(10000);
      ...
      else if(Tcount3>=Tcount1)                                          //T2 T4 T3 T1
      {
...
else if(Tcount3>=Tcount4)                                         //T3
{
  if(Tcount1>=Tcount2 && Tcount1>=Tcount4)                        //T3 T1
  {
    if(Tcount2>=Tcount4)                                          //T3 T1 T2 T4
    { 
   digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001011); 
shiftOut(dataPin, clockPin, MSBFIRST, B00000100);
...
delay(10000);
    ...
    else if(Tcount4>=Tcount2)                                                    //T3 T1 T4 T2
    {
      digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00001011); 
shiftOut(dataPin, clockPin, MSBFIRST, B00000100);
...
delay(10000);
  ...
  else if(Tcount2>=Tcount4)                                         //T3 T2
  {
    if(Tcount1>=Tcount4)                                           //T3 T2 T1 T4
    {
...
delay(10000);
    ...
    else if(Tcount4>=Tcount1)                                      //T3 T2 T4 T1
    {
...
delay(10000);
  ...
  {
if(Tcount1>=Tcount2)                                    //T3 T4 T1 T2
{
...
else if(Tcount2>=Tcount1)                                  //T3 T4 T2 T1
{
...
{
  if(Tcount1>=Tcount2 && Tcount1>=Tcount3)        //T4 T1
  {
    if(Tcount2>=Tcount3)                          //T4 T1 T2 T3
    {
      digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00000111); 
shiftOut(dataPin, clockPin, MSBFIRST, B00001000);
...
delay(10000);
    ...
    else if(Tcount3>=Tcount2)                     //T4 T1 T3 T2
    {
...
delay(10000);
  ...
  else if(Tcount2>=Tcount3)                    //T4 T2
  {
    if (Tcount1>=Tcount3)                      //T4 T2 T1 T3
    {
       digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00000111); 
shiftOut(dataPin, clockPin, MSBFIRST, B00001000);
...
delay(10000);
    ...
    else if (Tcount3>=Tcount1)        //T4 T2 T3 T1
    {
...
delay(10000);
  ...
  {
    if(Tcount1>=Tcount2)                               //T4 T3 T1 T2
    {
      digitalWrite(latchPin, LOW);
shiftOut(dataPin, clockPin, MSBFIRST, B00000111); 
shiftOut(dataPin, clockPin, MSBFIRST, B00001000);
...
delay(10000);
    ...
    else if(Tcount2>=Tcount1)                              //T4 T3 T2 T1
    {
